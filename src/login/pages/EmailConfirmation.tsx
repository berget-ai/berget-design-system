...
const SuccessIcon = () => (
    <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[hsl(var(--berget-primary))]/20 flex items-center justify-center">
        <svg className="w-10 h-10 text-[hsl(var(--berget-primary))]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="berget-auth-container px-4">
            <Card className="stat-card w-full max-w-2xl mx-auto">
                ...
                <CardContent className="space-y-6 text-center">
                    ...
                    <CardTitle className="text-3xl text-white font-serif">{advancedMsgStr("magicLinkSuccessfulLogin")}</CardTitle>

                    {magicLinkContinuation.sameBrowser && (
                        <div className="pt-4">
                            <Button asChild className="w-full">
                                <a href={magicLinkContinuation.url}>{advancedMsgStr("continueToApp")}</a>
                            </Button>
                        </div>
                    )}
                </CardContent>
