            ...
            <Card className="stat-card w-full max-w-2xl mx-auto">
                <CardHeader className="text-center">
                    <div className="flex justify-center mb-6">
                        <img src={BERGET_LOGO} alt="Berget Logo" className="h-16 w-auto logo-animate" />
                    </div>
                    <CardTitle className="text-3xl text-white font-serif">{advancedMsgStr("otpFormTitle")}</CardTitle>
                    <p className="text-white/60 mt-2">
                        {advancedMsgStr("otpFormSubtitle")} <span className="text-white font-medium">{auth.attemptedUsername}</span>
                    </p>
                    <a
                ...
                <CardContent className="space-y-6">
                    <form id="kc-otp-login-form" action={url.loginAction} method="post" className="space-y-6">
                        <div>
                            <label htmlFor="otp" className="block text-white/60 text-sm font-medium mb-2">
                                {msg("loginOtpOneTime")}
                            </label>
                            <input
                                id="otp"
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <Button type="submit" name="resend" id="kc-resend" variant="outline" className="w-full">
