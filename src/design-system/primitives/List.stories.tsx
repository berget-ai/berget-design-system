    ...
    <div className="w-[1200px]">
      ...
      <Panel variant="default" padding="none" radius="lg">
        <div className="relative z-10">
          ...
          {/* List Items */}
          <List>
            <ListItem icon={<Key className="w-5 h-5 text-white/60" />}>
            ...
            <ListItem icon={<Key className="w-5 h-5 text-white/60" />}>
              <div className="flex items-center gap-4">
                ...
                <div className="w-40 text-sm text-white/60">2026-01-13</div>
                <div className="w-40 text-sm text-white/60">Never</div>
                <div className="w-32 text-sm text-white/60">sk-...</div>
              </div>
            </ListItem>
...
export const SimpleList: Story = {
  render: () => (
    <Panel variant="default" padding="none" radius="lg" className="w-[600px]">
      <div className="relative z-10">
        <List>
          <ListItem icon={<Database className="w-5 h-5 text-white/60" />}>
            <div>
              <h3 className="text-base font-medium mb-1">PostgreSQL Database</h3>
              <p className="text-sm text-white/40">Production · 15.2 GB</p>
            </div>
          </ListItem>

          <ListItem icon={<Server className="w-5 h-5 text-white/60" />}>
            <div>
          ...
          <ListItem icon={<Users className="w-5 h-5 text-white/60" />}>
            <div>
    ...
    <Panel variant="default" padding="none" radius="lg" className="w-[800px]">
      <div className="relative z-10">
        ...
        <List>
          ...
          <ListItem icon={<Calendar className="w-5 h-5 text-white/60" />}>
            <div className="flex items-center gap-4">
              <div className="flex-1">
        ...
        <List>
          ...
          <ListItem icon={null} interactive={false}>
            <div className="flex justify-between items-center">
              ...
              <span className="text-base font-medium text-red-400">1,841</span>
            </div>
          </ListItem>
  ...
  render: () => (
    <Panel variant="default" padding="none" radius="lg" className="w-[600px]">
      <div className="relative z-10">
        ...
        <List>
          <ListItem icon={<Clock className="w-5 h-5 text-white/60" />}>
            <div>
          ...
          <ListItem icon={<Users className="w-5 h-5 text-white/60" />}>
            <div>
              <h3 className="text-base font-medium mb-1">Team Member Added</h3>
              <p className="text-sm text-white/40">
          ...
          <ListItem icon={<Key className="w-5 h-5 text-white/60" />}>
            <div>
              <h3 className="text-base font-medium mb-1">API Key Created</h3>
              <p className="text-sm text-white/40">
