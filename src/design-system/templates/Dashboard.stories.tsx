      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <Panel variant="default" padding="lg" radius="lg">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-6">
              <span className="text-base text-white/40">Account Balance</span>
        ...
        <Panel variant="default" padding="lg" radius="lg">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-6">
              ...
              <Cpu className="w-6 h-6 text-white/80" strokeWidth={1.5} />
            </div>
            <div className="space-y-2">
              <div className="flex items-baseline gap-3">
                <h3 className="text-3xl font-medium tracking-tight">24.3K</h3>
        ...
        <Panel variant="default" padding="lg" radius="lg">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-6">
              ...
              <TrendingUp className="w-6 h-6 text-white/80" strokeWidth={1.5} />
            </div>
            <div className="space-y-2">
              <div className="flex items-baseline gap-3">
                <h3 className="text-3xl font-medium tracking-tight">+23.5%</h3>
        ...
        <Panel variant="default" padding="lg" radius="lg">
          <div className="relative z-10">
            ...
            <div className="space-y-2">
              <div className="flex items-baseline gap-3">
                <h3 className="text-3xl font-medium tracking-tight">Active</h3>
              </div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-xl bg-white/5">
                <p className="text-sm text-white/40 mb-1">Total Requests</p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Panel variant="glass" padding="lg" radius="lg">
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-6">
                <span className="text-base text-white/40">With Glass</span>
                <TrendingUp
                  className="w-6 h-6 text-white/80"
                  strokeWidth={1.5}
                />
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-white/40">Liquid glass variant</p>
              </div>
            </div>
          </Panel>
          ...
          <Panel variant="default" padding="lg" radius="lg" bokeh={false}>
            <div className="relative z-10">
              ...
              <div className="space-y-2">
                <h3 className="text-3xl font-medium tracking-tight">Clean</h3>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Panel variant="default" padding="lg" radius="default">
              <div className="relative z-10">
                <p className="text-white/60 mb-2">Default (rounded-2xl)</p>
