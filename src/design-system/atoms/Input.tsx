        ...
        return (
            <div className="relative w-full">
                ...
                <input
                    type={type}
                    className={cn(
                        "flex h-10 w-full rounded-md border border-input bg-slate px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-moss/40 disabled:cursor-not-allowed disabled:opacity-50",
                        icon && "pl-10",
                        actionButton && "pr-12",
                        className
                    )}
