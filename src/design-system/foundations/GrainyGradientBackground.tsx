...
export type EllipseColor = "moss" | "lichen" | "spruce" | "fjord" | "slate" | "cloud";
...
const defaultEllipses: EllipseConfig[] = [
    {
        color: "moss",
        position: { left: "60.11%", right: "-33.49%", top: "44.65%", bottom: "8.81%" },
    ...
    {
        color: "moss",
        position: { left: "-2.66%", right: "-14.25%", top: "10%", bottom: "28.42%" },
    ...
    {
        color: "moss",
        position: { left: "35.22%", right: "-16.46%", top: "-32.33%", bottom: "63.63%" },
    ...
    {
        color: "lichen",
        position: { left: "-18.17%", right: "38.23%", top: "47.92%", bottom: "5.34%" },
    ...
    {
        color: "spruce",
        position: { left: "-22.84%", right: "40.78%", top: "-20.62%", bottom: "75.33%" },
    ...
    {
        color: "spruce",
        position: { left: "-23.29%", right: "67.49%", top: "-12.3%", bottom: "39.23%" },
    ...
    {
        color: "fjord",
        position: { left: "30%", right: "-20%", top: "70%", bottom: "-10%" },
 ...
 * </GrainyGradientBackground>
 *
 * <GrainyGradientBackground blur={100}>
 *   <Hero />
 * </GrainyGradientBackground>
 *
 * <GrainyGradientBackground
 *   ellipses={[
 *     { color: "moss", position: {...}, transform: "...", animation: "slow" },
 *     { color: "lichen", position: {...}, transform: "...", animation: "medium" }
 *   ]}
 * >
 *   <Hero />
 * </GrainyGradientBackground>
...
>(({ children, className, blur = 130, grain = 0.1, ellipses = defaultEllipses, ...props }, ref) => {
    return (
        <div
            ref={ref}
