...
const ColorSwatch = ({ name, value, hex }: { name: string; value: string; hex?: string }) => (
...
const TokenSection = ({ title, children }: { title: string; children: React.ReactNode }) => (
    <div className="mb-8">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">{children}</div>
    </div>
);
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-white/70 max-w-2xl mx-auto">
                        Berget Design System V2 - All foundational design tokens in one place
                    </p>
                </div>
                ...
                <TokenSection title="Typography">
                    <div className="space-y-12">
                        <div>
                            <div className="text-white/60 text-sm mb-6">Serif (Ovo) - Headings</div>
                            <h1 className="text-5xl font-serif text-white mb-6">H1 - 64px / 5rem</h1>
                            <h2 className="text-4xl font-serif text-white mb-6">H2 - 40px / 2.5rem</h2>
                        </div>
                        <div>
                            <div className="text-white/60 text-sm mb-6">Sans (DM Sans) - Body & UI</div>
                            <h3 className="text-2xl font-sans text-white mb-4">H3 - 24px / 1.5rem</h3>
                            <p className="text-base font-sans text-white mb-4">Body - 16px / 1rem</p>
                            <p className="text-sm font-sans text-white/70">Small - 14px / 0.875rem</p>
                        </div>
                    </div>
                </TokenSection>
                ...
                <TokenSection title="Icons">
                    <div className="space-y-8">
                        <div>
                            <div className="text-white/60 text-sm mb-6">Icon Specifications</div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                ...
                                <div className="bg-white/5 rounded-lg p-4">
                                    <div className="text-white font-medium mb-2">Stroke Width</div>
                                    <div className="text-white/70">1.5px</div>
                                </div>
                                <div className="bg-white/5 rounded-lg p-4">
                                    <div className="text-white font-medium mb-2">Default Size</div>
                                    <div className="text-white/70">32×32px</div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div className="text-white/60 text-sm mb-6">Common Icons (32×32px)</div>
                            <div className="grid grid-cols-4 md:grid-cols-8 gap-6">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    <ChevronRight strokeWidth={1.5} className="w-8 h-8 text-white" />
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    <BrainCircuit strokeWidth={1.5} className="w-8 h-8 text-white" />
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-white text-sm">rounded-full (Buttons/Badges)</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-lichen rounded-2xl" />
                                    <span className="text-white text-sm">rounded-2xl (Cards)</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-spruce rounded-md" />
                                    <span className="text-white text-sm">rounded-md (Inputs)</span>
                                </div>
                            </div>
                        </div>
                        <div>
